        ...
        <dl>
            <div class="flex">
                ...
                <div class="wrapp">
                   ...
                   <!-- button for pannick mode -->
                   <center><a href="send-sms.php"><input type="button" class="btn" value="Panick mode">
                    </a></center><br>
                   <!-- pannic mode ends -->
               <img height="500" width="300" border-radius="20px" src="<?php echo validate_image(isset($image_path) ? $image_path : "") ?>" alt="" id="cimg" class="img-fluid img-thumbnail bg-gradient-gray">
                    <div class="img-display">
                    <h3>Driver's Display picture</h3>
                    </div>
                </div>
            </div>
        </dl>
